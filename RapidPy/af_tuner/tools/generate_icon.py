...
def draw_icon(glyph_png: Path, output_png: Path, output_ico: Path) -> None:
    ...
    gradient.setColorAt(0.0, QtGui.QColor("#1A237E"))
    gradient.setColorAt(1.0, QtGui.QColor("#0D1659"))
...
def generate_icns(output_png: Path, output_icns: Path) -> bool:
    ...
    iconset_dir = output_icns.parent / "af_tuner.iconset"
...
def main() -> int:
    ...
    glyph_png = root / "assets" / "af_tuner_icon_glyph.png"
    output_png = root / "assets" / "af_tuner_icon.png"
    output_ico = root / "assets" / "af_tuner_icon.ico"
    output_icns = root / "assets" / "af_tuner_icon.icns"
