...
Private Sub RunUchannel()
    ...
    frmDCMotors.UpDownMove SCoilPos, 0, True
    ...
    EndPosition = (MinUpDownPos * MinUpDownPos / Abs(MinUpDownPos) + Abs(SampleLength)) * MeasPos / Abs(MeasPos)
    
    If Abs(EndPosition) > FloorPos * FloorPos / Abs(FloorPos) Then  'FloorPos will be different for other sample changer systems
        ...
        EndPosition = FloorPos * FloorPos / Abs(FloorPos)  'FloorPos will be different for other sample changer systems
