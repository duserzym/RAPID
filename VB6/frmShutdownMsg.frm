...
Begin VB.Form frmShutdownMsg 
   ...
   End
End
Attribute VB_Name = "frmShutdownMsg"
...
Private Sub Form_Load()
    ...
    ExitMsg = "Exiting Program..."
        
    'Now need to pick a font size so that the "Exiting Program..." message fits the
    'width of the form
    ...
    Me.lblShutdownMsg.ForeColor = QBColor(0)
    Me.lblShutdownMsg.FontSize = Me.FontSize
    Me.lblShutdownMsg.Caption = ExitMsg
    Me.lblShutdownMsg.Top = Me.ScaleHeight / 4
    Me.lblShutdownMsg.Left = 0.05 * Me.ScaleWidth
    Me.lblShutdownMsg.Visible = True
