...
End Sub
Public Sub GetChannelCollDependencies _
...
Public Function CheckChannelDependencies(ByRef AssignedChanCol As Channels, _
    ...
    For i = 1 To N
        ...
        With AssignedChanCol(i)
            ...
            Then
                ...
                DependencyList(0) = .ChanDesc & " Channel: " & .ChanName
    ...
    CheckChannelDependencies = DependencyMessage(DependencyList, _
                                                 ChanObj.BoardName, _
                                                 ChanObj.ChanName)
    ...
    Else
        ...
        Else
            ...
            For i = 1 To N
                ...
                ResolveChannelDependencies Asssignechancol, _
                                           SysChanCol, _
                                           Nothing
...
Public Function DeleteChanFromColl(ByRef AssignedChanCol As Channels, _
    ...
    doContinue = CheckChannelDependencies(AssignedChanCol, _
                                          TempChannels(ChanName))
        ...
        Else
            ...
            For i = 1 To N
                ...
                If j <> M + 10 Then
                    ...
                    ResolveChannelDependencies assignchancol, _
                                               OldChanCol(i), _
                                               Nothing
        ...
        For i = 1 To N
            ...
            With AssignedChanCol(i)
                ...
                Then
                    ...
                    DependencyList(N) = .ChanDesc & " Channel:" & .ChanName
...
Public Sub ArrayInterpolateAndSplice(ByRef PriorArray() As Double, _
    ...
    If NewArray Is Nothing Then Exit Sub
...
Public Sub LoadArrayToGrid(ByRef gridobj As MSHFlexGrid, _
                           ...
                           Optional ByVal AddLineNumbers As Boolean = False, _
                           Optional ByVal FormatString As String = vbNullString)
            ...
            For j = 0 To M - 1
                ...
                Else
                    ...
                    If FormatString = vbNullString Then
                        ...
                        'Set the text
                        .text = Trim(Str(DataArray(i, j)))
                        
                    Else
                    
                        'Set the text with formating
                        .text = Format(DataArray(i, j), FormatString)
    ...
    With gridobj
        ...
        For i = FirstRow To LastRow
            ...
            For j = FirstCol To LastCol
                ...
                DataArray(i - FirstRow, j - FirstCol) = val(.text)
...
'
Public Sub MedianThreeQuickSort1_2D(ByRef pvarArray() As Double, _
...
Public Sub ResizeGrid(ByRef gridobj As MSHFlexGrid, _
                      ...
                      Optional ByVal Multiplier As Double = 1.2)
    ...
    With gridobj
        ...
        For j = FirstCol To LastCol
            ...
            For i = FirstRow To LastRow
                ...
                If CallingForm.TextWidth(TempStr) > MaxWidth Then
...
Public Sub DeleteRow(ByRef gridobj As MSHFlexGrid, _
    ...
    With gridobj
        ...
        If FirstRowNumbered = True Then
        
            RenumberGridRow gridobj, _
                            CallingForm, _
                            0
